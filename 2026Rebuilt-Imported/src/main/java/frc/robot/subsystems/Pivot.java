...
import org.wpilib.math.system.DCMotor; //import org.wpilib.math.system.plant.DCMotor;
...
public class Pivot extends SubsystemBase {
  ...
  public Pivot() {
    ...
    absEncoder = new CANcoder(Constants.Pivot.ENCODER_ID, CANBus.systemcore(0)); //added CANBus systemcore
