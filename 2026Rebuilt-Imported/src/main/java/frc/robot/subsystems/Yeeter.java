...
import org.wpi.first.hal.FRCNetComm.tResourceType;
...
public class Yeeter extends SubsystemBase {
  ...
  public Yeeter(RobotContainer robotContainer){//Visabelle visabelle) {
    ...
    motor1 = new TalonFX(Constants.Yeeter.YEETER_MOTOR1_ID, CANBus.systemcore(0)); //added CANBus systemcore
    motor2 = new TalonFX(Constants.Yeeter.YEETER_MOTOR2_ID, CANBus.systemcore(0)); //added CANBus systemcore
