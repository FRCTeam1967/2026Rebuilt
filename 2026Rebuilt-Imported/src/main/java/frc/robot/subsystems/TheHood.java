...
public class TheHood extends SubsystemBase {
  ...
  public TheHood() {
    hoodMotor = new TalonFX(Constants.Hood.HOOD_MOTOR_ID, CANBus.systemcore(0)); //added CANBus systemcore
    absEncoder = new CANcoder(Constants.Hood.HOOD_CANCODER_ID, CANBus.systemcore(0)); //added CANBus systemcore
