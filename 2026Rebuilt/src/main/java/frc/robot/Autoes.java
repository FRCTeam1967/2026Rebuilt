...
//             new MovePivot(m_robotContainer.pivot, Constants.Pivot.DOWN_POSITION, 1.0), //wasnt there before
...
//     trenchToCenterEM.atPose("Deploy Eater", 0.2, Math.PI/4).onTrue(
//       Commands.parallel(
//         new MovePivot(m_robotContainer.pivot, Constants.Pivot.DOWN_POSITION, 0.5),
//         new RunEater(m_robotContainer.eater, Constants.Eater.EATER_MOTOR_SPEED), 
//         new RunIndexer(m_robotContainer.indexer, 10.0)
//       ).withTimeout(4)
//     );
